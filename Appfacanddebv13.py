...
def leer_txt_a_dataframe(file):
    ...
    try:
        ...
        nombre_archivo = "archivo_sin_nombre.txt"

    logging.info(f"Intentando leer archivo: {nombre_archivo}")
...
def generate_zip_with_summary(df, folder_base, modo_operacion, logo_bytes):
    ...
    with zipfile.ZipFile(zip_buffer, 'w', zipfile.ZIP_DEFLATED) as zipf:
        ...
        for (cobertura, factura), group in grouped:
            ...
            filename = (
                f"{safe_base}/{safe_cobertura}/ANAREFA_Analisis_{safe_factura}_{safe_cobertura}.xlsx"
